...
export default function BookingScreen({ navigation }) {
    ...
    function handleOnCancel(docId) {
        ...
        setIsLoading(false)
        db.doc(docId).update({ cancelled: true })
        setTimeout(() => {
            db.doc(docId).delete()
        }, 10000)
    }
    ...
    return <View style={styles.container}>
        ...
        <Text style={{ ...FONTS.h4_comfortaa, marginBottom: SIZES.padding * 3 }}>Do you need help ?</Text>

        <TouchableOpacity onPress={() => openScreen(1)} style={{ ...styles.Box, backgroundColor: COLORS.secondary }}>
            <Text style={{ ...FONTS.h5_comfortaa, color: COLORS.white, textAlign: "center" }}>Talk to a listener</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => openScreen(2)} style={{ ...styles.Box, backgroundColor: COLORS.orange }}>
            <Text style={{ ...FONTS.h5_comfortaa, color: COLORS.white, textAlign: "center" }}>Book a professional</Text>
        </TouchableOpacity>
